            ...
            permissions.entries.forEach {
                ...
                if(isGranted) {
                    ...
                    if(permissionName== Manifest.permission.READ_EXTERNAL_STORAGE){
                        Toast.makeText(
                            this, "Oops you denied the permission", Toast.LENGTH_SHORT
                        ).show()
                    }
                }
            }
        ...
        ibSave.setOnClickListener{
            ...
            if(isReadStorageAllowed()){
                ...
                lifecycleScope.launch{
                    val flDrawingView: FrameLayout=findViewById(R.id.fl_drawing_view_conatiner)
            ...
            if(mBitmap!=null){
                try {
                    ...
                    val f = File(externalCacheDir?.absoluteFile.toString()
                            + File.separator + "KidsDrawindApp" + System.currentTimeMillis()/1000 + ".png"
                    )
